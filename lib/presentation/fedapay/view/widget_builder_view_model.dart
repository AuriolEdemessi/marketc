...
class WidgetBuilderViewModel extends BaseViewModel {
  ...
  async {
    if (request.url.startsWith("https://marketscc.com/api/v0/exchange/transaction_api/checking")) {
      ...
      final transactionId = link.queryParameters['id'];
      callback!( {'transactionId': transactionId}, context);
      /**
